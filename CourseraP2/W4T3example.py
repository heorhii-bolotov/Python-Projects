...
txtreport = yaml.load(yml_MD, yaml.Loader)            # загружаем yaml файл markdown отчёта
txtreport.save()                         # сохраняем
print("Сохранено:", txtreport.filename)  # вывод

HTMLreport = yaml.load(yml_HTML, yaml.Loader)         # загружаем yaml файл markdown отчёта
